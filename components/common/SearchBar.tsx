                    ...
                    <div className="px-6">
                      <div className="mb-6 text-center">
                        <div className="flex items-center justify-center mb-3">
                          <div className="bg-gradient-to-br from-shop_dark_green to-shop_light_green p-3 rounded-full">
                            ...
                            {featuredProduct
                              ...
                              .map((item: Product) => (
                                <Link
                                  ...
                                  onClick={() => setShowSearch(false)}
                                  className="group bg-gradient-to-br from-gray-50 to-white hover:from-shop_light_green/5 hover:to-shop_dark_green/5 border border-gray-200 hover:border-shop_light_green rounded-xl p-4 transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
                                >
                                  <div className="flex gap-3">
                                    {/* Product Image */}
                                    <div className="relative h-20 w-20 flex-shrink-0 overflow-hidden rounded-lg border border-gray-200 group-hover:border-shop_light_green transition-colors duration-300">
                                      {item?.images && (
                                        <Image
                                          width={80}
                                          height={80}
